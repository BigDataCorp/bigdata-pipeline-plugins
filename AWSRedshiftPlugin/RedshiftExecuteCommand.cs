...
namespace AWSRedshiftPlugin
{
    public class RedshiftExecuteCommand : IActionModule
    {
        ...
        public IEnumerable<ModuleParameterDetails> GetParameterDetails ()
        {
            ...
            yield return new ModuleParameterDetails ("sqlScriptPath", typeof (string), "[optional] sql script path", true);

            yield return new ModuleParameterDetails ("customCSharpScriptPath", typeof (string), "[optional] s3 customCSharpScriptPath", true);
        }
